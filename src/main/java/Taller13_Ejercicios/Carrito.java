 ...
 */
// Aca sucdde un error debido a que no implementa el método pagar(), por eso no compila
//public class Carrito implements Pagable {
    // Falta el método pagar(), así que esto lanza error de compilación:
